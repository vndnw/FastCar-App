...
INSERT INTO cars (active, car_type, color, created_at, description, fuel_consumption, fuel_type, license_plate, model, name, price_per_hour, price_per4hour, price_per8hour, price_per12hour, price_per24hour, seats, status, transmission, updated_at, year, car_brand_id, location_id, user_id) VALUES
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      (TRUE, 'LUXURY', 'Đen', NOW(), 'Sedan hạng sang của Đức với thiết kế tinh tế và công nghệ vượt trội.', '9 L/100km', 'GASOLINE', '51K-987.65', 'C300 AMG', 'Mercedes-Benz C300', 400000, 1500000, 2800000, 3800000, 4500000, 5, 'BOOKED', 'AUTO', NOW(), 2023, 5, 3, 1),
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      (TRUE, 'STANDARD', 'Đen', NOW(), 'Phong cách thiết kế KODO độc đáo cùng trải nghiệm lái thú vị.', '6.8 L/100km', 'GASOLINE', '43A-121.21', 'CX-5', 'Mazda CX-5', 200000, 700000, 1300000, 1700000, 2100000, 5, 'BOOKED', 'AUTO', NOW(), 2022, 8, 3, 1),
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      (TRUE, 'LUXURY', 'Đen', NOW(), 'Sự kết hợp hoàn hảo giữa sang trọng, tiện nghi và độ tin cậy từ thương hiệu Lexus.', '9.2 L/100km', 'GASOLINE', '51K-111.22', 'RX 350', 'Lexus RX 350', 550000, 1900000, 3600000, 4800000, 6000000, 5, 'BOOKED', 'AUTO', NOW(), 2023, 16, 2, 3);
